...
cd %~p0/utils/
verpatch.exe ../dist/crouchjump.exe 1.0.2.0 /va /pv 1.0.2.0 /s description "A crouch-jump hotkey script for PUBG." /s product "Crouchjump" /s copyright "No copyright applied." /s company "https://github.com/snaacky"
cd %~p0/src/
@RD /S /Q "__pycache__"
